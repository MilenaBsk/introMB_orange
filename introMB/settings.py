"""
Django settings for introMB project.
...
SECRET_KEY = "django-insecure-1eorh6(+v^5!a#7b_#+8)!cvmb!x-b-7&jz7sri_6$2y5yd4+!"
...
WSGI_APPLICATION = "introMB.wsgi.application"
